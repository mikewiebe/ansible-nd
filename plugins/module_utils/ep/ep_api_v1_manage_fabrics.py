...
class EpApiV1ManageFabricsGet(FabricNameMixin, BaseModel):
    """
    # Summary
...
class EpApiV1ManageFabricsListGet(BaseModel):
    """
    # Summary
...
class EpApiV1ManageFabricsPut(FabricNameMixin, BaseModel):
    """
    # Summary
...
class EpApiV1ManageFabricsDelete(FabricNameMixin, BaseModel):
    """
    # Summary
...
class EpApiV1ManageFabricsSummaryGet(FabricNameMixin, BaseModel):
    """
    # Summary
